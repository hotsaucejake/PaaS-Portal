        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold">General Site Feedback</span>
                </div>
            </div>
               ...
               <div class="row">
                ...
                <form method="post" action="index.php?page=feedback" class="form-horizontal" name="feedbackForm" onsubmit="">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <button type="submit" name="newFeedback" class="btn red">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="portlet box red-soft">
                   ...
                   <div class="portlet-body">
                       <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="red" data-handle-color="#a1b2ff">
